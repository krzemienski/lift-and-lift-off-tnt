...
export default function SpecialtiesGrid({ specialties }: SpecialtiesGridProps) {
  return (
    <section className="py-20 md:py-32 px-6 bg-[#0B2545]/35 backdrop-blur-md">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto" style={{ textShadow: '0 1px 3px rgba(11, 37, 69, 0.8)' }}>
          ...
          {specialties.map((specialty, index) => (
            ...
            >
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">{specialty.title}</h3>
