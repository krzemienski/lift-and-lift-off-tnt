      ...
      <section className="relative pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-extrabold mb-6 text-white" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.8)' }} data-testid="heading-strength">
              STRENGTH TRAINING
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.8)' }} data-testid="text-strength-description">
            ...
            <Card className="backdrop-blur-sm bg-primary/10 border-primary">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Assessment verifies hinge/squat patterns and load tolerance.
                </p>
